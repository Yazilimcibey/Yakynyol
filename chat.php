...
?>
<script>
    var inlisceler=[];turkmenceler=[];description=[];music=[];aydym=[];inlisceler2=[];turkmenceler2=[];description2=[];music2=[];aydym2=[];
</script>
<?php 
    ...
    <div class="chat" id="chat1">
        <div class="content" id="content">
            <div class="container">
                <div class="col-md-12" id='tet' style='height:400px;overflow:scroll;'>
