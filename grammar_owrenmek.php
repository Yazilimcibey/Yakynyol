...
<script>
    var inlisceler=[];turkmenceler=[];dogrytext=[];aydym=[];aydym2=[];music=[];inlisceler2=[];turkmenceler2=[];dogrytext2=[];music2=[];gosmaca1=[];gosmaca12=[];gosmaca2=[];gosmaca22=[];
</script><audio id='y'><source src=words/hello.mp3 id='src'>Bolanok</audio>
<?php 
...
if (isset($_SESSION['username'])) {
    ...
    ";
    ?>
    <script src="js/chat_grammar.js"></script>
